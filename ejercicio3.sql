...
select codigo
from almacenes
where (select count(*) from cajas where almacen = codigo)
-- 3.10
...
--3.16
delete from cajas
where ALMACEN in (select codigo from almacenes where capacidad < (select count(*) from cajas where almacen = codigo))